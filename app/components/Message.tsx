 ...
 * @LastEditors: xinxu
 * @LastEditTime: 2023-07-06 16:12:36
 * @FilePath: /chatgpt-next/app/components/Message.tsx
 */
'use client';
  ...
  return (
    ...
    >
      {isAssistant ? (
        ...
        //   })}
        // />
        <Image src={'/chatgpt-icon-green.png'} width={50} height={50} alt="logo" className="w-[50px] h-[50px]" />
      ) : (
        // <HeroiconsUser className="rounded w-10 h-10 p-1.5 bg-white dark:bg-gray-200" />
        <Image src={'/avatar.jpg'} width={40} height={40} alt="avatar" className="h-[40px]" />
      )}
      <div
